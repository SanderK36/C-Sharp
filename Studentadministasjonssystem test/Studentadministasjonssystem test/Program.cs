namespace Studentadministasjonssystem_test
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Karakter karakter1 = new Karakter(student1.StudentID, Naturfag.Fagkode, 6);
            Karakter karakter2 = new Karakter(student2.StudentID, Norsk.Fagkode, 5);
            ...
            student1.showTotalPoints();
            Console.WriteLine("-------------------------------------------------------");
            student2.SkrivUtInfo();
            student2.GetAverageGrade();
            student2.showTotalPoints();
